//
//  SequenceCommandClusterSelectorViewController.h
//  LightMaster
//
...
@interface SequenceCommandClusterSelectorViewController : NSViewController <NSTableViewDelegate, NSTableViewDataSource>
{
    Data *__weak data;
